...
Part of the **agent surface** layer of Aihu. This package is retained only as a deprecated compatibility adapter for existing consumers.
...
<sub><i>Auto-generated against `@aihu/agent-acp@0.2.2`.</i></sub>
